...
def extract_text_from_pdf(pdf_file) -> Tuple[str, dict]:
    ...
    try:
        ...
        metadata = {"page_count": page_count, "char_count": char_count, "word_count": word_count}

        logger.info(
            f"PDF extraction completed: {page_count} pages, {char_count} chars, {word_count} words"
        )
